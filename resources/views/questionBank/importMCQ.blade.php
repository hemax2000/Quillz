...
@section('content')
    ...
    {!! Form::open(['action'=> ['App\Http\Controllers\QuestionBankController@importQuestionMCQ', $question->id], 'method' => 'POST']) !!}
        ...
        {{Form::select('correct', array( 1 => __('text.answer 1'), 2 => __('text.answer 2'), 3 => __('text.answer 3'), 4 => __('text.answer 4')),$correct, ['class' => 'form-select'])}}
        </div>
        <br>
        <hr>
        <div class="form-group">
